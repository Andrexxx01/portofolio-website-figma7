          ...
          <div className="bg-white rounded-2xl p-6 lg:p-10 shadow-card">
            ...
            <div className="bg-brand-primary-200 rounded-full py-4 px-6 mb-8">
              <div className="grid grid-cols-3 text-white font-semibold text-sm lg:text-lg text-center">
                <div>Skill</div>
                <div className="ml-14 lg:ml-0">Me</div>
                <div className="ml-10 lg:ml-0">Other</div>
              </div>
            </div>
            ...
            <div className="flex flex-col divide-y divide-brand-neutral-300">
              {row.map((item, index) => (
                <div
                  key={index}
                  className="grid grid-cols-3 items-center py-6 font-medium text-brand-neutral-950 text-sm lg:text-lg"
                >
                  <div className="text-center ml-2">{item}</div>
                  {/* Me */}
                  <div className="flex justify-center">
                    <div className="w-6 h-6 ml-15 lg:ml-0 lg:w-7 lg:h-7 aspect-square rounded-full bg-brand-secondary-300 flex items-center justify-center">
                      <Check
                  ...
                  <div className="flex justify-center mr-6">
                    <div className="w-6 h-6 ml-10 lg:ml-0 lg:w-7 lg:h-7 aspect-square rounded-full bg-brand-neutral-400 flex items-center justify-center">
